...
describe('MetaRealm', () => {
    it('Should open a realm, given a list of schema names', async () => {
        ...
        const realm1: Realm = await MetaRealm.loadRealmFromSchemas({ realmPath: testRealmPath1, schemaNames: [SCHEMA_1.name, SCHEMA_2.name, SCHEMA_4.name] });
